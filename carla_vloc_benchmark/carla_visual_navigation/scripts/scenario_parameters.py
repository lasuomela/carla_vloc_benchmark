...
def test_experiment_parameters(logger_script_path, catalog_path):
   ...
   # scenario_save_dir = '/scenarios/illumination_town01_autopilot'
    ...
    #local_extractor_group = [{"local_extractor_name_template": "r2d2", "local_matcher_name_template": "NN-ratio"}]

    # global_extractor_name = ["netvlad", "dir"]
    # local_extractor_group = [{"local_extractor_name_template": "d2net-ss", "local_matcher_name_template": "NN-ratio"},
    ...
    #                          {"local_extractor_name_template": "sift", "local_matcher_name_template": "NN-ratio"}]
    ...
    if controller_entry_name[0] == "CarlaAutopilotAgent":
    ...
    "scenario_save_dir": scenario_save_dir,
    "town_name_template": town_names,
...
def illumination_experiment_parameters_autopilot(logger_script_path, catalog_path):
